        ...
        <div className="container">
          <div className="clients-grid reveal">
            {[
              ...
              {name:'Airtel',              file:'airtel-logo.png',                     dark:false},
              {name:'Yas',                 file:'Yas-logo.png',                        dark:true},
              {name:'TTCL',                file:'ttcl-logo.png',                       dark:true},
              ...
              {name:'Stanbic',             file:'Stanbic-logo.png',                    dark:true},
              {name:'DTB',                 file:'dtb-logo.png',                        dark:true},
